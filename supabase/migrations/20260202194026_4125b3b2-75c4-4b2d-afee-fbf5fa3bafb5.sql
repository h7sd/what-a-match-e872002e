-- Create a SECURITY DEFINER function to return only public-safe profile data
...
-- Create function for alias lookup
...
-- Users can only view their own profile directly (with all fields)
